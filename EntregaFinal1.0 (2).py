...
ax.legend(loc='upper right')
ax.set_title('Cantidad de casos en cada provincia de menores de edad')
...
#Creamos el grafico, añadiendo los valores
lugares=['Violencia en la calle','Vioencia doméstica', 'Violencia institucional', 'Violencia laboral']
